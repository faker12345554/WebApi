package com.common.common.apppush;

import com.common.common.apppush.android.AndroidBroadcast;
import com.common.common.apppush.android.AndroidCustomizedcast;
import com.common.common.apppush.android.AndroidGroupcast;
import com.common.common.apppush.android.AndroidUnicast;
import com.common.common.apppush.ios.IOSBroadcast;
import com.common.common.apppush.ios.IOSGroupcast;
import com.common.common.apppush.ios.IOSUnicast;
...
public class Demo {
	...
	public int sendAndroidUnicast(String deviceToken, String ticker, String title, String text, Date date) throws Exception {
		...
		unicast.setDescription("测试消息");
		unicast.goAppAfterOpen();
		unicast.setExpireTime(sdf.format(date));
	...
	public int sendAndroidGroupcast(JSONObject tagJson, String ticker, String title, String contents, String startTime) throws Exception {
	 ...
	 public void sendAndroidCustomizedcast(String alias, String alias_type, String ticker, String title, String text, Date date) throws Exception {
	 ...
	 client.send(customizedcast);
	  ...
	  customizedcast.setProductionMode(); client.send(customizedcast); }
